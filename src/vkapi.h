...
public: //autogenereated
    ...
    void groupsEditPlace (std::string group_id, std::string title, std::string address, std::string country_id, std::string city_id, std::string latitude, std::string long_itude);
    ...
    void newsfeedSearch (std::string q, std::string extended, std::string count, std::string latitude, std::string long_itude, std::string start_time, std::string end_time, std::string start_from, std::string fields, std::string start_id, std::string offset);
    ...
    void photosEdit (std::string owner_id, std::string photo_id, std::string caption, std::string latitude, std::string long_itude, std::string place_str, std::string foursquare_id, std::string delete_place);
    ...
    void photosSave (std::string album_id, std::string group_id, std::string server, std::string photos_list, std::string hash, std::string latitude, std::string long_itude, std::string caption);
    ...
    void placesAdd (std::string type, std::string title, std::string latitude, std::string long_itude, std::string country, std::string city, std::string address);
    ...
    void placesCheckin (std::string place_id, std::string text, std::string latitude, std::string long_itude, std::string friends_only, std::string services);
    void placesGetById (std::string places);
    void placesGetCheckins (std::string latitude, std::string long_itude, std::string place, std::string user_id, std::string offset, std::string count, std::string timestamp, std::string friends_only, std::string need_places);
    void placesGetTypes ();
    void placesSearch (std::string q, std::string city, std::string latitude, std::string long_itude, std::string radius, std::string offset, std::string count);
    ...
    void usersGetNearby (std::string latitude, std::string long_itude, std::string accuracy, std::string timeout, std::string radius, std::string fields, std::string name_case);
    ...
    void videoSearch (std::string q, std::string sort, std::string hd, std::string adult, std::string filters, std::string search_own, std::string offset, std::string long_er, std::string shorter, std::string count, std::string extended);
