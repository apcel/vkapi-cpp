...
void messagesSend (std::string user_id, std::string peer_id, std::string domain, std::string chat_id, std::string user_ids, std::string message, std::string guid, std::string lat, std::string long, std::string attachment, std::string forward_messages, std::string sticker_id);
...
void photosSearch (std::string q, std::string lat, std::string long, std::string start_time, std::string end_time, std::string sort, std::string offset, std::string count, std::string radius);
...
void wallEdit (std::string owner_id, std::string post_id, std::string friends_only, std::string message, std::string attachments, std::string services, std::string signed, std::string publish_date, std::string lat, std::string long, std::string place_id);
...
void wallPost (std::string owner_id, std::string friends_only, std::string from_group, std::string message, std::string attachments, std::string services, std::string signed, std::string publish_date, std::string lat, std::string long, std::string place_id, std::string post_id);
